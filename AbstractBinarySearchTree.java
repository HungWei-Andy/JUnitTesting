...
public abstract class AbstractBinarySearchTree {
     ...
     */
    public abstract Node createNode(int value, Node parent, Node left, Node right);
    ...
    public void printTreeInOrder(Node entry) {
        if (entry != null) {
    ...
    public void printTreePreOrder(Node entry) {
        if (entry != null) {
            if (entry.value != null) {
                System.out.println(entry.value);
            }
    ...
    public void printTreePostOrder(Node entry) {
        if (entry != null) {
            printTreeInOrder(entry.left);
            printTreeInOrder(entry.right);
            if (entry.value != null) {
